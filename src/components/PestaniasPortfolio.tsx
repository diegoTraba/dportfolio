...
export const PestaniasPortfolio = ({ pestanias }: PestaniasPortfolioPropiedades) => {
  ...
  return (
    <div className="border-b border-[var(--colorPrimario)] bg-custom-header">
      <nav className="flex space-x-1" aria-label="Pestanias">
          ...
          <Link
            ...
            className={`${
              activeTab === pestania.id
                ? 'border-[var(--colorPrimario)] bg-[var(--colorSecundario)] text-[var(--colorTerciario)] font-semibold'
