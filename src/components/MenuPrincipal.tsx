      ...
      <div className="md:hidden">
        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            {nombreUsuario && (
              <p className="text-xs text-custom-foreground mr-2">
                Hola,{" "}
                <span className="font-medium">
            ...
            <button
              onClick={manejarCerrarSesion}
              className="p-2 bg-red-600 hover:bg-red-700 rounded-md transition-colors text-white border border-red-600"
              title="Cerrar sesión"
            >
              <svg
                className="w-5 h-5"
