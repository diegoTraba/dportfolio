...
export default function Configuracion() {
  ...
  useEffect(() => {
    const loadUserPreferences = async () => {
      ...
      try {
        ...
        setMensaje({ tipo: 'error', texto: 'Error al cargar las preferencias' })
      } finally {
   ...
   */
  const updatePreference = async (field: keyof UserPreferences, value: boolean | string) => {
    // Si no hay usuario autenticado, no hacer nada
    if (!userId) return
    ...
    try {
      ...
      setMensaje({ tipo: 'exito', texto: 'Preferencias actualizadas correctamente' })
      ...
      setMensaje({ tipo: 'error', texto: 'Error al actualizar las preferencias' })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!formData.nuevaContrasenia) {
        ...
        newErrors.nuevaContrasenia = 'La nueva contraseña no cumple los requisitos'
      }
      ...
      const esContraseniaValida = await bcrypt.compare(formData.contraseniaActual, user.password)
      ...
      const { enviarEmailCambioContrasenia } = await import('@/lib/email/accionesEmail')
      await enviarEmailCambioContrasenia(user.email, user.name, formData.nuevaContrasenia)
      ...
      setMensaje({ 
        tipo: 'exito', 
        texto: 'Contraseña actualizada correctamente. Se ha enviado un email de confirmación.' 
      })
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select 
                    ...
                    onChange={(e) => updatePreference('main_currency', e.target.value)}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input 
                      ...
                      onChange={(e) => updatePreference('email_notification', e.target.checked)}
                      disabled={loadingPreferences}
                    />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input 
                      ...
                      onChange={(e) => updatePreference('push_notification', e.target.checked)}
                      disabled={loadingPreferences}
                    />
                    <div className={`w-11 h-6 bg-gray-200 peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 ${loadingPreferences ? 'opacity-50 cursor-not-allowed' : ''}`}></div>
                  </label>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3 max-w-md">
                    ...
                    <div>
                      ...
                      <CampoContrasenia
                        ...
                        onChange={(value) => handleChange('contraseniaActual', value)}
                    ...
                    <div>
                      ...
                      <CampoContrasenia
                        ...
                        onChange={(value) => handleChange('nuevaContrasenia', value)}
                    ...
                    <div>
                      ...
                      <CampoContrasenia
                        ...
                        onChange={(value) => handleChange('confirmarContrasenia', value)}
