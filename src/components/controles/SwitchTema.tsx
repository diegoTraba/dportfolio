  ...
  return (
    <label className="relative inline-flex items-center cursor-pointer">
      ...
      <div className="w-11 h-6 bg-gray-200 peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 relative">
        {/* Icono del sol */}
        <svg 
          className={`w-2.5 h-2.5 absolute top-1/2 left-1 -translate-y-1/2 transition-opacity duration-200 ${
        ...
        {/* Icono de la luna */}
        <svg 
          className={`w-2.5 h-2.5 absolute top-1/2 right-1 -translate-y-1/2 transition-opacity duration-200 ${
            esOscuro ? 'text-blue-200 opacity-100' : 'text-gray-400 opacity-60'
          }`}
          fill="currentColor" 
          viewBox="0 0 20 20"
        >
